                ...
                <form action="{{ route('cerdas.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" placeholder="Ej. C-012 o M-09" class="w-full text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring focus:ring-brand-200 focus:ring-opacity-50 @error('codigo') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @enderror" required>
                            @error('codigo')
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" placeholder="Ej. Margarita, La gorda..." class="w-full text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring focus:ring-brand-200 focus:ring-opacity-50 @error('nombre') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @enderror">
                            @error('nombre')
                                <p class="text-rose-600 text-xs mt-1.5 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="raza" id="raza" value="{{ old('raza') }}" placeholder="Ej. Landrace, Duroc, Large White" class="w-full text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring focus:ring-brand-200 focus:ring-opacity-50 @error('raza') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @enderror">
                            @error('raza')
                                <p class="text-rose-600 text-xs mt-1.5 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" class="w-full text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring focus:ring-brand-200 focus:ring-opacity-50 @error('fecha_nacimiento') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @enderror">
                    ...
                    <div>
                        ...
                        <textarea name="notas" id="notas" rows="4" placeholder="Algún detalle clínico, rasgos particulares, antecedentes, etc." class="w-full text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring focus:ring-brand-200 focus:ring-opacity-50 @error('notas') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @enderror">{{ old('notas') }}</textarea>
                        @error('notas')
                            <p class="text-rose-600 text-xs mt-1.5 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        <a href="{{ route('cerdas.index') }}" class="inline-flex items-center px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 text-xs font-bold border border-gray-300 rounded-lg shadow-sm transition-colors duration-150">
                            Cancelar
                        </a>

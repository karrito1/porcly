<x-modal name="verraco-delete-modal" maxWidth="sm" focusable>
    <div class="p-6 space-y-5">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h3 class="text-lg font-semibold text-gray-900">Eliminar Verraco</h3>
                <p id="verraco-delete-text" class="mt-1 text-sm text-gray-500">¿Seguro que deseas eliminar este verraco? Esta acción no se puede deshacer.</p>
            </div>
        </div>

        <form id="verraco-delete-form" method="POST" class="flex justify-end gap-3 border-t border-gray-100 pt-4">
            @csrf
            @method('delete')
